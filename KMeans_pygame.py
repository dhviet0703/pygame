...
pygame.display.set_caption("K_mean visualization")
running = True
...
while running:
	...
	screen.blit(text_plus, (863,53))

	# Draw K- button
	pygame.draw.rect(screen, BLACK, (950,50,50,50))
	screen.blit(text_minus, (966,51))
	...
	# Draw Reset button
	pygame.draw.rect(screen, BLACK, (850, 550, 200, 50))
	...
	for event in pygame.event.get():
		...
		if event.type == pygame.MOUSEBUTTONDOWN:
			...
			# Change K button +
			if 850 < mouse_x < 950 and 50 < mouse_y < 100 and K < 8:
				K += 1
				print("K+")

			# Change K button -
			if 950 < mouse_x < 1050 and 50 < mouse_y < 100 and K > 0:
				K -= 1
				print("K-")

			# Run button 
			if 850 < mouse_x < 1050 and 150 < mouse_y < 200:
				labels = []
			...
			# Random button
			if 850 < mouse_x < 1050 and 250 < mouse_y < 300:
				labels = []
				clusters = []
				for i in range(K):
			...
			# Reset button
			if 850 < mouse_x < 1050 and 550 < mouse_y < 600:
				K = 0
				error = 0
				points = []
				clusters = []
